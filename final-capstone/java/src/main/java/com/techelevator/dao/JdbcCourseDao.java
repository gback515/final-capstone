...
public class JdbcCourseDao implements CourseDao {
    ...
    public List<Course> findAll() {
        ...
        String sql = "SELECT course_id, course_name, course_length, coordinate, address, city, state, zip FROM courses;";
    ...
    public Course findCourseById(long courseId) {
        String sql = "SELECT course_id, course_name, course_length, coordinate, address, city, state, zip FROM courses WHERE course_id = ?;";
