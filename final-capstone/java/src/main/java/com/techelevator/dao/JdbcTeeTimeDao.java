...
public class JdbcTeeTimeDao implements TeeTimeDao {
    ...
    public List<TeeTime> findAll() {
        ...
        String sql = "SELECT tee_time_id, user_id, course_id, tee_time_date, tee_time FROM tee_times;";
    ...
    public List<TeeTime> findTeeTimeByUser(long userId) {
        List<TeeTime> teeTimes = new ArrayList<>();
        String sql = "SELECT tee_time_id, user_id, course_id, tee_time_date, tee_time FROM tee_times WHERE user_id = ?;";
    ...
    public TeeTime create(long userId, long courseId, String teeTimeDate, String time) {
        ...
        String sql = "INSERT INTO tee_times (tee_time_id, user_id, course_id, tee_time_date, tee_time) VALUES(?,?,?,?,?) RETURNING tee_time_id";
    ...
    private TeeTime mapRowToTeeTime(SqlRowSet results) {
        ...
        teeTime.setCourseId(results.getLong("course_id"));
